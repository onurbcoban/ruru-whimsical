        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '16px' }}>
          <div>
            ...
            <p style={{ fontSize: '13.5px', color: 'var(--text-soft)', marginTop: '4px' }}>
              Atölyeden yazılar, kumaş felsefesi ve ilham alıntılarını buradan ekleyebilir, düzenleyebilir ve silebilirsiniz.
            </p>
          </div>
      ...
      {journalNotes.length === 0 ? (
        ...
        >
          <p style={{ fontSize: '15px', color: 'var(--text-soft)', margin: 0 }}>
            Henüz eklenmiş bir günlük yazısı bulunmuyor.
          </p>
        </div>
      ) : (
